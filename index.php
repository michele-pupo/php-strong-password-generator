    ...
    <div class="container">
        ...
        <form action="index.php" method="get">
            ...
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="usa_numeri" name="usa_numeri">
                <label class="form-check-label" for="usa_numeri">Usa numeri</label>
            </div>
            <!-- indica l'uso di lettere maiuscole nella password -->
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="usa_lettere_maiuscole" name="usa_lettere_maiuscole">
            ...
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="usa_lettere_minuscole" name="usa_lettere_minuscole">
